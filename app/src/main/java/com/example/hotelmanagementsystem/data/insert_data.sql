...
INSERT INTO hotel_chain(hotel_chain_id, hotel_chain_name, hotel_chain_contact_number, hotel_chain_email_address, hotel_chain_website, head_office_address) VALUES
 (1,'Best Western Hotels','456-865-8956','bw123@gmail.com','https://www.bestwestern.com/','20400 Phoenix, AZ 85027, USA'),
 (2,'China Town Hotels','110-526-5647','chinatown123@gmail.com','https://www.chinatown.com/','20400 Phoenix, AZ 85027, USA'),
 (3,'Elite Hotels','546-874-6547','elite.tea213@gmail.com','https://www.elitendhe.com/','8033 King George Boulevard, Surrey, BC V3W 5B4, Canada'),
 (4,'Cosmopolitan Hotels','852-741-9765','cosmo.hotels123@gmail.com','https://www.cosmopolitan.com/','1565 E South St, Globe, AZ 85501, USA'),
 (5,'Prestige Hotels','657-784-3647','prestige2453@gmail.com','https://www.prestige.com/','32 Gandhi Road, Mumbai, Maharashtra 534076, India');
...
INSERT INTO hotel(hotel_id, hotel_name, hotel_contact_number, hotel_email_address, hotel_website, hotel_description, hotel_floor_count, hotel_room_capacity, hotel_chain_id, address, star_rating, check_in_time, check_out_time) VALUES
 (1,'King George Inn & Suites','604-502-9564','kgi123@gmail.com','https://www.kgi1.com/','A 2-mile drive from Besh Ba Gowah Archaeological Park.',5,45,1,'8033 King George Boulevard, Surrey, BC V3W 5B4, Canada',4, '08:00:00','16:00:00'),
 (2,'Copper Hills Inn','547-964-9564','chinni123@gmail.com','https://www.chin12.com/','A 2-mile drive from Besh Ba Gowah Archaeological Park.',6,55,1,'1565 E South St, Globe, AZ 85501, USA', 5, '08:00:00','16:00:00'),
 (3,'Sawmill Inn','547-964-3452','sawmill.inn@gmail.com','https://www.chin123.com/','A 3-mile drive from Fairview Park.',4,50,1,'32 Gandhi Road, Mumbai, Maharashtra 534076, India', 5,'08:00:00', '16:00:00'),
 (4,'Northgate Inn','547-876-5422','northgate.inn@gmail.com','https://www.chin1234.com/','A 4-mile drive from Conestoga Mall',3,40,1,'706 Idle rd, Saskatoon, SK S2L 562, Bangladesh', 5,'08:00:00', '16:00:00');
...
INSERT INTO hotel.hotel (hotel_id, hotel_name, hotel_contact_number, hotel_email_address, hotel_website, hotel_description, hotel_floor_count, hotel_room_capacity, hotel_chain_id, address, star_rating, check_in_time, check_out_time) VALUES
 (6, 'Chinatown Heritage Hotel Shanghai', '+86-21-6322-8888', 'heritage@chinatown.cn', 'https://www.chinatownheritage.com', 'Historic hotel in Shanghai Old Town', 8, 89, 2, 'No. 123 Nanjing Road, Huangpu District, Shanghai, China', 4, '08:00:00','16:00:00'),
 (7, 'Dragon Gate Inn Beijing', '+86-10-6513-7788', 'beijing@chinatown.cn', 'https://www.dragongateinn.com', 'Near Tiananmen Square', 12, 210, 2, '78 Dongsi West Street, Beijing, China', 5, '08:00:00','16:00:00'),
 (8, 'Golden Phoenix Guangzhou', '+86-20-8331-1888', 'gz@chinatown.cn', 'https://www.goldenphoenix.com', 'Pearl River view luxury hotel', 30, 450, 2, '555 Renmin North Road, Guangzhou, China', 5, '08:00:00','16:00:00');

-- Chain 3: Elite Hotels
INSERT INTO hotel.hotel (hotel_id, hotel_name, hotel_contact_number, hotel_email_address, hotel_website, hotel_description, hotel_floor_count, hotel_room_capacity, hotel_chain_id, address, star_rating, check_in_time, check_out_time) VALUES
 (9, 'Elite Palace Stockholm', '+46-8-566-21000', 'stockholm@elite.se', 'https://www.elite.se', 'Luxury in central Stockholm', 15, 278, 3, 'Sankt Eriksgatan 115, Stockholm, Sweden', 5, '08:00:00','16:00:00'),
 (10, 'Elite Hotel Marina Tower', '+46-8-670-5500', 'marina@elite.se', 'https://www.elite.se/marina', 'Stunning waterfront location', 12, 186, 3, 'Saltsjöqvarns Kaj 25, Nacka, Sweden', 5, '08:00:00','16:00:00');

-- Chain 4: Cosmopolitan Hotels
INSERT INTO hotel.hotel (hotel_id, hotel_name, hotel_contact_number, hotel_email_address, hotel_website, hotel_description, hotel_floor_count, hotel_room_capacity, hotel_chain_id, address, star_rating, check_in_time, check_out_time) VALUES
 (11, 'Cosmopolitan Dubai Marina', '+971-4-444-5555', 'dubai@cosmopolitan.com', 'https://www.cosmopolitan-dubai.com', 'Infinity pool & beach access', 55, 450, 4, 'JBR, Dubai Marina, UAE', 5, '08:00:00','16:00:00'),
 (12, 'Cosmopolitan Singapore', '+65-6338-0066', 'singapore@cosmopolitan.com', 'https://www.cosmopolitan.sg', 'Orchard Road luxury', 35, 388, 4, '2 Orchard Turn, Singapore', 5, '08:00:00','16:00:00'),
 (13, 'Cosmopolitan Tokyo Ginza', '+81-3-6264-5800', 'tokyo@cosmopolitan.jp', 'https://www.cosmopolitan-tokyo.com', 'Ginza luxury shopping district', 25, 280, 4, '6-12-3 Ginza, Chuo-ku, Tokyo, Japan', 5, '08:00:00','16:00:00');

-- Chain 5: Prestige Hotels
INSERT INTO hotel.hotel (hotel_id, hotel_name, hotel_contact_number, hotel_email_address, hotel_website, hotel_description, hotel_floor_count, hotel_room_capacity, hotel_chain_id, address, star_rating, check_in_time, check_out_time) VALUES
 (14, 'Prestige Resort Santorini', '+30-22860-25000', 'santorini@prestige.gr', 'https://www.prestige-santorini.com', 'Caldera view villas', 6, 72, 5, 'Oia, Santorini, Greece', 5, '08:00:00','16:00:00'),
 (15, 'Prestige Palace Monaco', '+377-98-06-3636', 'monaco@prestige.mc', 'https://www.prestige-monaco.com', 'Monte Carlo luxury', 10, 95, 5, 'Place du Casino, Monaco', 5, '08:00:00','16:00:00'),
 (16, 'Prestige Maldives Overwater', '+960-664-8888', 'maldives@prestige.com', 'https://www.prestige-maldives.com', 'Private island resort', 1, 60, 5, 'Baa Atoll, Maldives', 5, '08:00:00','16:00:00');
...
INSERT INTO guests(guest_id, guest_first_name, guest_last_name, guest_contact_number, guest_email_address, guest_credit_card, guest_id_proof, address) VALUES
 (1,'Jane','Doe','132-456-8564','jane.doe@gmail.com',NULL,'/images/drivingLicense1023','49 Dave Street, Kitchener, ON N2C 2P6, Canada'),
 (2,'Jerry','Thachter','564-896-4752','jerry.ytsvg@gmail.com',NULL,'/images/passport45612','64 Victoria Street, Kitchener, ON N2C 2M6, Canada'),
 (3,'Rihanna','Perry','745-986-7451','rih.vfdj89@gmail.com',NULL,'/images/drivingLicense4889','79 Connaught Street, London, ON N2C 2K3, Canada'),
 (4,'Mathew','Jose','489-624-8633','mathew.jose@gmail.com',NULL,'/images/drivingLicense8945','45 Sweden St. Street, London, ON N2A 0E4, Canada'),
 (5,'Jessica','Smith','487-956-8963','jess.smith@gmail.com',NULL,'/images/passport7896','60 Lincoln Street, Guelph, ON N2C 2E8, Canada');
...
INSERT INTO employees(emp_id, emp_first_name, emp_last_name, emp_designation, emp_contact_number, emp_email_address, department_id, address, hotel_id) VALUES
 (1,'Jen','Fen','Waiter','123-789-7896','jen.rds@gmail.com',1,'45 Vanier Park, Kitchener, ON Sd3 d35, Canada',1),
 (2,'Tom','Pitt','Manager','565-789-7896','tom.pit@gmail.com',3,'41 Greenfield, London, ON 234 987, Canada',1),
 (3,'David','Lawrence','Cashier','852-789-7896','david.lawr@gmail.com',2,'89 Jacob Rd, Paris, ON 467 289, Canada',1),
 (4,'Joseph','Aniston','Cook','765-789-7896','joseph.anis@gmail.com',2,'85 Martin Street, Ottawa, BC 263 987, Canada',1),
 (5,'Jeny','Patel','Manager','531-789-7896','jeny.patel@gmail.com',3,'78 Josseph St. Street, Guelph, BC 267 387, Canada',1);
